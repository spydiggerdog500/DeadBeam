...
// end include: preamble.js
  ...
  function _KSConnectWS(id, url) {
          if (typeof this.instances[id] !== 'undefined') {
              this.instances[id].Connect(url);
          }
      }

  function _KSCreateWS(onConnect, onDisconnect, onMessage) {
  ...
  function _KSDisconnectWS(id) {
          if (typeof this.instances[id] !== 'undefined') {
              this.instances[id].Disconnect();
          }
      }

  function _KSDisposeWS(id){
          if (typeof this.instances[id] !== 'undefined') {
              delete this.instances[id];
          }       
      }

  function _KSReadWS(id, data, offset, count) {
          if (typeof this.instances[id] !== 'undefined') {
  ...
  function _KSWriteWS(id, data, offset, count) {
          if (typeof this.instances[id] !== 'undefined') {
...
var wasmImports = {
  ...
  "KSConnectWS": _KSConnectWS,
  "KSCreateWS": _KSCreateWS,
  "KSDisconnectWS": _KSDisconnectWS,
  "KSDisposeWS": _KSDisposeWS,
  "KSReadWS": _KSReadWS,
  "KSWriteWS": _KSWriteWS,
